       ...
       <div className="section-inner">
        ...
        <div className="advisor-card reveal">
          ...
          <button className="advisor-submit" onClick={recommendBouquet}>
            ...
            <i className={`fa-solid fa-wand-magic-sparkles advisor-loading-icon-hidden ${!loading ? 'show' : ''}`}></i>
            Get Personalized Suggestion
          </button>
          {showResults && (
            <div id="advisor-results" className={showResults ? 'advisor-results-show' : 'advisor-results-hidden'}>
              <strong className="advisor-recommendation-title">Recommendation ✿</strong>
              <div id="recommendation-text" className="advisor-recommendation-text">{recommendation}</div>
            </div>
          )}
        </div>
    </section>
