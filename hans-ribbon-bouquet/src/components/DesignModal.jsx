      ...
      <div className="modal-box">
          ...
          <div className="addon-grid" id="addonsGrid">
            {addonOptions.map(addon => (
              <label key={addon.id} className="addon-label">
                ...
                />
                <i className={addon.icon} style={{color:'var(--pink)',fontSize:'0.8rem'}}></i>
                {addon.label}
              </label>
            ))}
          </div>
        ...
        <div className="step-box">
          ...
          <div className="half-payment-box">
            ...
            <p style={{fontSize:'0.75rem',color:'#8a6070',marginTop:'0.4rem'}}>Non-refundable deposit to confirm your order. Remainder due upon delivery.</p>
          </div>
